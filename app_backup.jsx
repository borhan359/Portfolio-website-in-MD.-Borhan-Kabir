...
const FloatingNavbar = () => {
    ...
    return (
        <nav className="fixed bottom-6 left-1/2 -translate-x-1/2 md:bottom-auto md:top-1/2 md:left-6 md:right-auto md:-translate-x-0 md:-translate-y-1/2 z-50 flex flex-row md:flex-col gap-3 md:gap-4">
            {navLinks.map((link) => (
                <a 
                    key={link.name} 
                    href={link.href} 
